        ...
        <div className="no3_box clearfix" >  
            <div style={{ width: 170}} className="no3_box_nav">
                <Menu defaultSelectedKeys={['1']} defaultOpenKeys={['sub1']} mode="inline" theme="dark" inlineCollapsed={state.collapsed}>
                    ...
                    <SubMenu key="sub3" icon={<AppstoreOutlined />} title="员工业绩分析">
                    ...
                    <SubMenu key="sub4" icon={<AppstoreOutlined />} title="客户画像分析">
                    ...
                    <SubMenu key="sub6" icon={<AppstoreOutlined />} title="排行榜">
                    ...
                    <SubMenu key="sub7" icon={<AppstoreOutlined />} title="办公分析">
