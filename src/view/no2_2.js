            ...
            <div className="no2_2_box_top clearfix">
                ...
                <div className="no2_2_box_top_middle">
                    <div className="no2_2_box_top_middle_content">
                        <input placeholder="请输入线索名称/手机/电话"></input>
                ...
                <div className="no2_2_box_top_right">
                    ...
                    <Modal footer={null} title="新建线索" visible={isModalVisible} onOk={handleOk} width={700} style={{width:700}} onCancel={handleCancel}>
                ...
                <div className="no2_2_box_content_top clearfix">
                    <div className="no2_2_box_content_top_1">
                        ...
                        <ConfigProvider locale={zhCN}>
                            ...
                            options={options} onChange={onChange}
                            allowClear={false}
                            style={{width:'70px',height:'31px',border:'none'}}
                            placeholder="更多" />
                        </ConfigProvider>
                    </div>
