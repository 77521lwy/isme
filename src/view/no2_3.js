            ...
            <div className="no2_2_box_top clearfix">
                ...
                <div className="no2_2_box_top_middle">
                    <div className="no2_2_box_top_middle_content">
                        <input placeholder="请输入客户名称/手机/电话"></input>
                ...
                <div className="no2_2_box_top_right">
                    ...
                    <Modal footer={null} title="新建客户" visible={isModalVisible} onOk={handleOk} width={700} style={{width:700}} onCancel={handleCancel}>
