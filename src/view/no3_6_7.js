...
let No3_6_7=function(params){
    ...
    axios.post('http://crm.cimns.com/index.php/bi/ranking/recordCustomer',{
        structure_id: 1,
        type: 'year'
    })
    .then(res => {
    ...
    return(
        <div className="no3_1_1_box">
            ...
            <div className="no3_1_1_box_content">
                <h3 style={{marginTop:10}}>跟进客户数排行（按创建人、跟进时间统计）</h3>
